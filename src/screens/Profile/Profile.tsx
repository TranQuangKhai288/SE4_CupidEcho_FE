...
const ProfileScreen: React.FC = ({}) => {
  ...
  return (
    ...
    <View className="mx-6 mt-6 bg-purple-500 p-4 rounded-2xl shadow-lg">
      <Text className="text-white text-lg font-bold">Enjoy All Benefits!</Text>
  ...
  {/* Menu Items */}
  <View className="mt-6">
        <MenuItem icon={<Settings size={24} color="black" />} text="Settings" />
        <MenuItem icon={<Moon size={24} color="black" />} text="Dark Mode" />
        <MenuItem icon={<Users size={24} color="black" />} text="Help Center" />
        <MenuItem icon={<Users size={24} color="black" />} text="Invite Friends" />
        <MenuItem icon={<LogOut size={24} color="red" />} text="Logout" isLogout />
      </View>
  </ScrollView>
  );
};
